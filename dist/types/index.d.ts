...
export interface CostCalculatorServiceInterface {
    ...
    validateBooking(data: CreateBookingRequest): Promise<{
        isValid: boolean;
        errors: string[];
    }>;
}
...
export type HallBusinessEvent = HallBookingCreatedEvent | HallBookingCancelledEvent | HallQuotationCreatedEvent | HallQuotationAcceptedEvent;
