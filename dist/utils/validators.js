...
class Validators {
    static validateCreateHall(data) {
        const errors = [];
    ...
    static validateUpdateHall(data) {
        const errors = [];
    ...
    static validateCreateBooking(data) {
        const errors = [];
        if (!data.hallId) {
        ...
        if (!data.eventType || !Object.values(types_1.EventType).includes(data.eventType)) {
    ...
    static validateUpdateBooking(data) {
        const errors = [];
        ...
        if (data.eventType !== undefined && !Object.values(types_1.EventType).includes(data.eventType)) {
        ...
        if (data.status !== undefined && !Object.values(types_1.BookingStatus).includes(data.status)) {
    ...
    static validateCreateQuotation(data) {
        const errors = [];
        if (!data.hallId) {
            errors.push('Hall ID is required');
        }
    ...
    static validateLineItem(data) {
        const errors = [];
        if (!data.itemType || !Object.values(types_1.LineItemType).includes(data.itemType)) {
    ...
    static validateCreatePayment(data) {
        ...
        if (!data.paymentType || !Object.values(types_1.PaymentType).includes(data.paymentType)) {
            errors.push('Valid payment type is required');
        }
        if (!data.paymentMode || !Object.values(types_1.PaymentMode).includes(data.paymentMode)) {
    ...
    static validateCreateAvailability(data) {
        const errors = [];
        if (!data.hallId) {
            errors.push('Hall ID is required');
        }
