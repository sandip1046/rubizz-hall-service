...
const envSchema = joi_1.default.object({
    ...
    REDIS_SESSION_URL: joi_1.default.string().required(),
    REDIS_SESSION_HOST: joi_1.default.string().required(),
    REDIS_SESSION_PORT: joi_1.default.number().default(6379),
    REDIS_SESSION_PASSWORD: joi_1.default.string().required(),
    REDIS_SESSION_USERNAME: joi_1.default.string().default('default'),
    REDIS_SESSION_TLS: joi_1.default.boolean().default(true),
    REDIS_SESSION_DB: joi_1.default.number().default(0),
    REDIS_CACHE_URL: joi_1.default.string().required(),
    REDIS_CACHE_HOST: joi_1.default.string().required(),
    REDIS_CACHE_PORT: joi_1.default.number().default(6379),
    REDIS_CACHE_PASSWORD: joi_1.default.string().required(),
    REDIS_CACHE_USERNAME: joi_1.default.string().default('default'),
    REDIS_CACHE_TLS: joi_1.default.boolean().default(true),
    REDIS_CACHE_DB: joi_1.default.number().default(1),
    REDIS_QUEUE_URL: joi_1.default.string().required(),
    REDIS_QUEUE_HOST: joi_1.default.string().required(),
    REDIS_QUEUE_PORT: joi_1.default.number().default(6379),
    REDIS_QUEUE_PASSWORD: joi_1.default.string().required(),
    REDIS_QUEUE_USERNAME: joi_1.default.string().default('default'),
    REDIS_QUEUE_TLS: joi_1.default.boolean().default(true),
    REDIS_QUEUE_DB: joi_1.default.number().default(2),
